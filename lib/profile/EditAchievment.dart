...
class EditAchievmentForm extends StatefulWidget {
  ...
  EditAchievmentForm(this.level3Competencylist, this.strCompetencyTypeId,
      this.strcompetencyTypeName, this.achivmentModel);

  @override
  EditAchievmentFormState createState() {
    return new EditAchievmentFormState(level3Competencylist, achivmentModel);
  }
}

class EditAchievmentFormState extends State<EditAchievmentForm> {
  EditAchievmentFormState(this.level3Competencylist, this.achivmentModel);
  ...
  List<bool> assestListSelected = new List();
  ...
  bool validationCheck() {
    if (strCompetencyValue == "") {
      ...
      ToastWrap.showToast("Please Select Skill...!");
      return false;
    } else if (strLevelValue == "") {
      ToastWrap.showToast("Please Select Achievement level...!");
      return false;
    } else if (strFromDate == "") {
      ToastWrap.showToast("Please Select From Date...!");
      return false;
    } else if (strToDate == "") {
      ToastWrap.showToast("Please Select To Date...!");
      return false;
    }
    return true;
  }
  ...
  Future apiCalling() async {
    try {
      ...
      Response response = await new ApiCalling()
          .apiCallPutWithMapData(context, Constant.ENDPOINT_ADD_ACHEVMENT, map);
  ...
  void initState() {
    ...
    titleController = new TextEditingController(text: achivmentModel.title);
    descController =
        new TextEditingController(text: achivmentModel.description);
    ...
    if (achivmentModel.fromDate != null &&
     ...
     /* fromDateController = new TextEditingController(
          text: new DateFormat("dd-MM-yyyy").format(date));*/
      fromDateController = new TextEditingController(
          text: new DateFormat("MM-dd-yyyy").format(date));
    ...
    if (achivmentModel.toDate != null &&
     ...
     /* toDateController = new TextEditingController(
          text: new DateFormat("dd-MM-yyyy").format(date));*/
      toDateController = new TextEditingController(
          text: new DateFormat("MM-dd-yyyy").format(date));
    ...
    assestList.add(new Assest("sxdcv", "sdc", "sd", false));
...
//--------------------------------Image Selectedview -------------------------
    ...
    Future<Null> selectToDate(BuildContext context) async {
      ...
      if (picked != null) {
       ...
       /* var difference = picked.difference(
            DateTime.parse(converttoYYYYMMDD("16-01-2019").replaceAll("/", "-")));
        ToastWrap.showToast(difference.inDays);
                            ...
                            Column(
                              ...
                              children: <Widget>[
                                PaddingWrap.paddingfromLTRB(
                                    ...
                                    0.0,
                                    0.0,
                                    getTextLabel("Title", 16.0, new Color(0XFFA8B3B9),
                                        FontWeight.normal)),
                                titleUi,
                                PaddingWrap.paddingfromLTRB(
                                    0.0,
                                    ...
                                    0.0,
                                    0.0,
                                    getTextLabel("Description", 16.0, new Color(0XFFA8B3B9),
                                        FontWeight.normal)),
                                descriptrionUi,
                                PaddingWrap.paddingfromLTRB(
                                    0.0,
                                ...
                                PaddingWrap.paddingfromLTRB(
                                    ...
                                    10.0,
                                    0.0,
                                    getTextLabel("Achievement Level (0-10)", 16.0,
