...
class AddGroupWidget extends StatefulWidget {
  ...
  AddGroupWidgetState createState() {
    return new AddGroupWidgetState();
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    final groupName = new Container(
        ...
        child: new TextFormField(
          keyboardType: TextInputType.text,maxLength: 50,
          decoration: new InputDecoration(
            filled: true,
            hintText: "Group Name",counterText: "",
          ...
          validator: (val) => val.trim().isEmpty ? 'Please enter group name.' : null,
    ...
    final aboutGroupUi = new Container(
        ...
        child: new TextFormField(
          ...
          decoration: new InputDecoration(
            filled: true,
            hintText: "About Group",counterText: "",
            hintStyle: new TextStyle(color: new Color(0XFFB1B4C0)),
            fillColor: Colors.transparent,
              border: OutlineInputBorder(
                  borderSide: BorderSide(color: Colors.grey[300],)
          ...
          validator: (val) => val.trim().isEmpty ? 'Please enter group motive' : null,
